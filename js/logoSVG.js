...
const logoSVG = (root) => {
    ...
    svgElem.setAttributeNS(null,'width', '96');
    svgElem.setAttributeNS(null,'height', '94');
    svgElem.setAttributeNS(null,'viewBox', '0 0 96 94');
    ...
    // svgElem.appendChild(path13);
    //defs
    const defs = document.createElement('defs');
    svgElem.appendChild(defs);
    //linearGradient1
    const linearGradient = document.createElementNS(null,'linearGradient');
    ...
    //linearGradient2
    const linearGradient2 = document.createElementNS(null,'linearGradient');
    ...
    ////linearGradient3
    const linearGradient3 = document.createElementNS(null,'linearGradient');
    ...
    //linearGradient4
    const linearGradient4 = document.createElementNS(null,'linearGradient');
